# 🐒💰 SeiMoney DeFi Contracts

**Complete DeFi ecosystem built on Sei Network with CosmWasm smart contracts**

## 🏗️ **Architecture Overview**

SeiMoney is a comprehensive DeFi platform featuring 6 core smart contracts:

- **💰 Payments** - Protected transfers with expiry & refunds
- **👥 Groups** - Group pooling & contribution management
- **🏺 Pots** - Savings goals & milestone tracking
- **🏷️ Alias** - Username registry & address resolution
- **🛡️ Risk Escrow** - Dispute resolution & multi-party escrow
- **🏦 Vaults** - AI-powered yield farming & portfolio management
